    ...
    for event in pygame.event.get():
        ...
        # When a KEYDOWN event is detected
            ...
            check_keydown_events(event, ai_settings, screen, stats, sb, ship, 
                aliens, bullets)
        # When a KEYUP event is detected        
...
def start_game(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Start the game."""
    # Reset the dynamic game settings.
...
def start_new_level(ai_settings, screen, stats, sb, ship, 
        aliens, bullets):
    """
    Start a new level: destroy existing bullets, speed up the game, 
    leveling up, and create a new fleet."""
    bullets.empty()
...
def get_number_aliens_x(ai_settings, alien_width):
    ...
    # Spacing between each alien and side margins are equal to one alien width.
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    """
    Check if the fleet is at an edgr, 
...
def store_high_score(stats):
    """Store the high score in the high_score.txt when the game ends."""
